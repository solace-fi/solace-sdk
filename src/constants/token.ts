...
const SOLACE_ADDRESS: { [chainID: number]: string } = {
  ...
  [5]: "0x501acE9c35E60f03A2af4d484f49F9B1EFde9f40", // Goerli
...
const DAI_ADDRESS: { [chainID: number]: string } = {
  ...
  [5]: "0x6a49238e4d0fA003BA07fbd5ec8B6b045f980574",
...
const WETH_ADDRESS: { [chainID: number]: string } = {
  ...
  [5]: "0x714ecd380a9700086eadac03297027baf4686276",
...
const WBTC_ADDRESS: { [chainID: number]: string } = {
  ...
  [5]: "0xD129f9A01Eb0d41302A2F808e9Ebfd5eB92cE17C",
...
const USDC_ADDRESS: { [chainID: number]: string } = {
  ...
  [5]: "0x995714E92a094Ea9b50e9F23934C36F86136A46c",
...
const USDT_ADDRESS: { [chainID: number]: string } = {
  ...
  [5]: "0x92f2F8d238183f678a5652a04EDa83eD7BCfa99e",
...
const FRAX_ADDRESS: { [chainID: number]: string } = {
  ...
  [5]: "0xA542486E4Dc48580fFf76B75b5c406C211218AE2",
...
const GoerliTokenList: { [token: string]: { name: string; symbol: string; decimals: number } } = {
  [MasterToken.dai]: { name: "Dai Stablecoin", symbol: "DAI", decimals: 18 },
  [MasterToken.usdc]: { name: "USD Coin", symbol: "USDC", decimals: 6 },
...
const AuroraTokenList: { [token: string]: { name: string; symbol: string; decimals: number } } = {
  ...
  [MasterToken.btc]: { name: "Wrapped BTC", symbol: "WBTC", decimals: 8 },
  [MasterToken.frax]: { name: "Frax", symbol: "FRAX", decimals: 18 },
  [MasterToken.wnear]: { name: "NEAR", symbol: "NEAR", decimals: 24 },
...
export const MasterTokenList: {
  [chainId: number]: { [token: string]: { name: string; symbol: string; decimals: number } }
} = {
  [1]: MainnetTokenList,
  [4]: RinkebyTokenList,
  [5]: GoerliTokenList,
