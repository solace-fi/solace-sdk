...
import { BondTellerErc20_ABI, BondTellerEth_ABI, BondTellerMatic_ABI, BondTellerFtm_ABI } from "../"
...
export class Bonder {
  ...
  constructor(
    ...
    if (String(storedType) === "eth") {
      this.bondTellerContract = new Contract(
        bondTellerContractAddress,
        BondTellerEth_ABI,
   ...
   */
  public async claimPayout(bondID: BigNumberish, gasConfig?: GasConfiguration): Promise<providers.TransactionResponse> {
    invariant(
      providers.JsonRpcSigner.isSigner(this.walletOrProviderOrSigner),
      "cannot execute mutator function without a signer"
    )
  ...
  public async deposit(
    ...
    const tx: providers.TransactionResponse = await this.bondTellerContract.deposit(
      deposit,
      minAmountOut,
      depositor,
      stake,
  ...
  public async depositSigned(
    ...
    const tx: providers.TransactionResponse = await this.bondTellerContract.depositSigned(
      deposit,
      minAmountOut,
      depositor,
      stake,
  ...
  public async depositEth(
    ...
    const tx: providers.TransactionResponse = await this.bondTellerContract.depositEth(minAmountOut, depositor, stake, {
      value: deposit,
      ...gasConfig
    })
    return tx
  ...
  public async depositWeth(
    ...
    const tx: providers.TransactionResponse = await this.bondTellerContract.depositWeth(
      deposit,
      minAmountOut,
      depositor,
      stake,
  ...
  public async depositWethSigned(
    ...
    const tx: providers.TransactionResponse = await this.bondTellerContract.depositWethSigned(
      deposit,
      minAmountOut,
      depositor,
      stake,
  ...
  public async depositMatic(
    ...
    const tx: providers.TransactionResponse = await this.bondTellerContract.depositMatic(
      minAmountOut,
      depositor,
      stake,
      { value: deposit, ...gasConfig }
    )
    return tx
  }
  ...
  public async depositWmatic(
    ...
    const tx: providers.TransactionResponse = await this.bondTellerContract.depositWmatic(
      deposit,
      minAmountOut,
      depositor,
      stake,
  ...
  public async depositWmaticSigned(
    ...
    const tx: providers.TransactionResponse = await this.bondTellerContract.depositWmaticSigned(
      deposit,
      minAmountOut,
      depositor,
      stake,
  ...
  public async depositFtm(
    ...
    const tx: providers.TransactionResponse = await this.bondTellerContract.depositFtm(minAmountOut, depositor, stake, {
      value: deposit,
      ...gasConfig
    })
    return tx
  ...
  public async depositWftm(
    ...
    const tx: providers.TransactionResponse = await this.bondTellerContract.depositWftm(
      deposit,
      minAmountOut,
      depositor,
      stake,
